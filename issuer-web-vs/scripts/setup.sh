#!/usr/bin/env bash
# =============================================================================
# Issuer Web VS — Local Setup
# =============================================================================
#
# This script sets up the Issuer Web VS Agent locally (child service):
...
#   ./issuer-web-vs/scripts/setup.sh
#
# =============================================================================
...
USER_ACC="${USER_ACC:-issuer-web-vs-admin}"
...
SERVICE_DESCRIPTION="${SERVICE_DESCRIPTION:-Web credential issuer for the Verana demo ecosystem}"
...
sleep 1
ngrok http "$VS_AGENT_PUBLIC_PORT" --log=stdout > /tmp/ngrok-issuer-web-vs.log 2>&1 &
NGROK_PID=$!
sleep 5
...
log "Issuer Web VS setup complete!"
echo ""
